...
const TestimonialSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='text-3xl fond-medium text-gray-800'>Testimonials</h2>
      ...
      <div className='grid grid-cols-auto gap-8 mt-14'>
        {
          dummyTestimonial.map((testimonial, index) => (
            <div key={index} className='text-sm text-left border border-gray-500/10  pb-6 bg-white rounded-lg shadow-[0px_4px_14px_0px] overflow-hidden shadow-black/5'>
