    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10 '>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10  border-b border-white/30'>
        ...
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <ul className='flex md:flex-col justify-between text-sm text-white/80 md:space-y-2'>
            <li><a href="#">Home</a></li>
        ...
        <div className='hidden md:flex flex-col md:items-start items-center w-full'>
          ...
          <div className='flex items-center gap-4 pt-2'>
            ...
            className='border border-gray-500/30 bg-gray-800 text-gray-500 placholder-gray-500 outline-none w-64 h-9 rounded px-2 text-sm'/>
            <button className='bg-blue-600 w-24 h-9 text-white rounded'>Susbcribe</button>
          </div>
        </div>
      </div>
