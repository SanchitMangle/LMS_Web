...
const CourseDetails = () => {
  ...
  const [isAlreadyEnrolled, setIsAlreadyEnrooled] = useState(false)
  const [playerData, setPlayerData] = useState(null)

  const { allCourses, calculateRating, calculateCourseChapterTime, calculateCourseDuration,
  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        <div className='absolute left-0 top-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'>

        </div>

        {/* Left column */}

        <div className='max-w-xl z-10 text-graay-500'>
          ...
          <p className='text-sm'>Course By : <span className='underline text-blue-600 cursor-pointer'>GreatDev</span></p>
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-non overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          {
