...
import CoursCard from '../../components/students/CoursCard'
...
return (
  <>
    <div className='relative md:px-36 px-8 pt-20 text-left'>
      ...
      {
        input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-8 -mb-3 text-gray-600'>
          <p>{input}</p>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-16 gap-3 px-2 md:p-0'>
        {
          filteredCourse.map((course, index) => <CoursCard key={index} course={course} />)
        }
      </div>
    </div>
    <Footer/>
